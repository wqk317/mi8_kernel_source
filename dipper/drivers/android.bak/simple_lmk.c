...
static const unsigned short adjs[] = {
	...
	1300, /* CACHED_APP_LMK_FIRST_ADJ */
	1200, /* CACHED_APP_MIN_ADJ */
	1100, /* SERVICE_B_ADJ */
	900, /* PREVIOUS_APP_ADJ */
	800, /* HOME_APP_ADJ */
	700, /* SERVICE_ADJ */
	600, /* HEAVY_WEIGHT_APP_ADJ */
	500, /* BACKUP_APP_ADJ */
	400, /* PERCEPTIBLE_LOW_APP_ADJ */
	300, /* PERCEPTIBLE_APP_ADJ */
	200, /* VISIBLE_APP_ADJ */
	100, /* PERCEPTIBLE_RECENT_FOREGROUND_APP_ADJ */
	50 /* FOREGROUND_APP_ADJ */
};
